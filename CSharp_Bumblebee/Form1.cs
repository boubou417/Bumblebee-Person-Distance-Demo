...
namespace CSharp_Bumblebee
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeTitleBar()
        {
            ...
            maximizeButton.Font = new Font("Segoe UI Symbol", 14, FontStyle.Regular);
        ...
        private Button CreateTitleButton(string text)
        {
            ...
            button.FlatAppearance.MouseDownBackColor = Color.FromArgb(20, 120, 210);
            return button;
        }
        ...
        private void UpdateMaximizeButton()
        {
            ...
            maximizeButton.AccessibleName = WindowState == FormWindowState.Maximized
                ? "還原視窗"
                : "最大化視窗";
        }
